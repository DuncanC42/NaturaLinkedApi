...
import bzh.duncan.naturalinkedapi.service.image.IImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> saveImages(
            ...
            @RequestParam("postId") Long postId  // Assurez-vous que c'est bien postId et non productId
    ) {
        try{
            List<Image> imageDtoList = imageService.saveImage(files, postId);
